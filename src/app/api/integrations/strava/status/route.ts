...
function createConfigDiagnostics() {
  return {
    ...
    hasSupabaseUrlAlias: hasEnvValue(process.env.SUPABASE_URL),
    ...
    hasSupabaseAnonKeyAlias: hasEnvValue(process.env.SUPABASE_ANON_KEY),
    hasSupabaseServiceRoleKey: hasEnvValue(process.env.SUPABASE_SERVICE_ROLE_KEY),
    hasSupabaseServiceKeyAlias: hasEnvValue(process.env.SUPABASE_SERVICE_KEY),
