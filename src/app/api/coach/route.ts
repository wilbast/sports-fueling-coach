...
function createSystemPrompt(): string {
  return [
    ...
    "Garmin ist die priorisierte Aktivitätsquelle. Wenn externalActivities.sourcePriority=garmin_primary ist, behandle den Garmin-Datensatz als kanonische Aktivität; Strava hat dort nur fehlende Felder ergänzt. Zähle mergedSourceProviders niemals als mehrere Einheiten.",
    "Nutze garmin.normalized und garmin.recoverySnapshot bei jeder Trainings-, Belastungs-, Regenerations- und Fueling-Empfehlung, sofern Daten vorhanden sind. Berücksichtige Schlafdauer/-qualität/-phasen, HRV samt Baseline und Status, Ruhepuls, Stress, Body Battery, SpO2, Atmung, Training Readiness, Recovery Time, Trainingsstatus, akute Last, Load Ratio/Focus, VO2max, Schwelle, FTP, Hitze-/Höhenakklimatisierung sowie Gewicht und Körperzusammensetzung.",
    "Bewerte Garmin-Gesundheitssignale im Trend und zusammen mit den tatsächlich erledigten Aktivitäten. Ein einzelner Ausreißer darf keine harte Absage begründen; mehrere übereinstimmende Warnsignale sollen Intensität, Umfang, Regeneration und Fueling sichtbar beeinflussen.",
    ...
    "Nutze bei externen Aktivitäten alle verfügbaren Kriterien aus dem Kontext: Distanz, Dauer, Pace/Geschwindigkeit, Herzfrequenz, Leistung, Kadenz, Höhenmeter, Kalorien, Relative Effort, Training Load, Indoor/Outdoor, Gerät und Schuhe. Garmin hat bei Dubletten Vorrang vor Strava.",
