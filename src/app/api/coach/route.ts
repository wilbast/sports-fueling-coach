...
function createSystemPrompt(): string {
  return [
    ...
    "Nutze garmin.normalized und garmin.recoverySnapshot bei jeder Trainings-, Belastungs-, Regenerations- und Fueling-Empfehlung, sofern Daten vorhanden sind. Berücksichtige Schlafdauer/-qualität/-phasen, HRV samt Baseline und Status, Ruhepuls, Stress, Body Battery, SpO2, Atmung, Training Readiness, Recovery Time, Trainingsstatus, akute Last, Load Ratio/Focus, VO2max, Schwelle, FTP sowie Hitze-/Höhenakklimatisierung.",
